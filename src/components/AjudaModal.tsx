...
const SECOES: Secao[] = [
  ...
  },
  {
    ...
    itens: [
      ...
      { titulo: 'Declarações — Editar Modelos', texto: 'O texto de cada uma das cinco declarações pode ser editado pela secretaria, parágrafo por parágrafo, incluindo o título e se mostra ou não a assinatura e o rodapé com o endereço. Ao salvar, a versão editada passa a valer nas declarações novas. O botão Voltar ao original descarta as edições. Importante: as declarações de Escolaridade, SETRANSP e Vacina que o aluno emite sozinho no painel dele ainda usam a versão escrita fixa no código — editar o modelo aqui muda só o que sai por esta tela.' },
